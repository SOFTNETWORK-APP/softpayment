package app.softnetwork.payment.annotation;

import java.lang.annotation.*;

/**
 * Marks APIs that are considered internal to payment and may change at any point in time without any
 * warning.
 *
 * <p>For example, this annotation should be used when the Scala {@code private[payment]} access
